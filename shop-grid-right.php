                                ...
                                <div class="u-s-p-y-60">
                                    ...
                                    <ul class="shop-p__pagination">
                                        <li class="is-active">
                                            ...
                                            <a href="shop-grid-right.php">1</a></li>
                                        <li>

                                            <a href="shop-grid-right.php">2</a></li>
                                        <li>

                                            <a href="shop-grid-right.php">3</a></li>
                                        <li>

                                            <a href="shop-grid-right.php">4</a></li>
                                        <li>

                                            <a class="fas fa-angle-right" href="shop-grid-right.php"></a></li>
                                    </ul>
                                    <!--====== End - Pagination ======-->
                                </div>
                            </div>
