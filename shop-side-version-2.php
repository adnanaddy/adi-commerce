                           ...
                           <div class="shop-w__wrap collapse show" id="s-category">
                              <ul class="shop-w__category-list gl-scroll">
                                 <li class="has-list">
                                    ...
                                    <span class="js-shop-category-span is-expanded fas fa-chevron-down u-s-m-l-6"></span>
                                    <ul style="display:block">
                                       <li class="has-list">
                                          <a href="#">3D Printer & Supplies</a>
                                          <span class="js-shop-category-span fas fa-chevron-down u-s-m-l-6"></span>
                                          <ul>
                                             <li>
                                                <a href="#">3d Printer</a>
                                             </li>
               ...
               <div class="shop-p">
                     ...
                     <div class="row is-grid-active">
                           ...
                           <div class="product-m">
                              ...
                              <div class="product-m__content">
                                 <div class="product-m__category">
                                    <a href="shop-side-version-2.php">Men Clothing</a>
                                 </div>
                                 <div class="product-m__name">
                                    <a href="product-detail.php">New Fashion B Nice Elegant</a>
                                 </div>
                        ...
                        <div class="col-lg-4 col-md-6 col-sm-6">
                           <div class="product-m">
                              ...
                              <div class="product-m__content">
                                 <div class="product-m__category">
                                    <a href="shop-side-version-2.php">Women Clothing</a>
                                 </div>
                                 <div class="product-m__name">
                                    <a href="product-detail.php">New Dress A Nice Elegant</a>
                                 </div>
                                 <div class="product-m__rating gl-rating-style"><i class="fas fa-star"></i><i class="fas fa-star"></i><i class="fas fa-star-half-alt"></i><i class="far fa-star"></i><i class="far fa-star"></i>
                                    <span class="product-m__review">(23)</span>
                                 </div>
                        ...
                        <div class="col-lg-4 col-md-6 col-sm-6">
                           <div class="product-m">
                              ...
                              <div class="product-m__content">
                                 ...
                                 <div class="product-m__name">
                                    <a href="product-detail.php">New Dress B Nice Elegant</a>
                                 </div>
                                 <div class="product-m__rating gl-rating-style"><i class="fas fa-star"></i><i class="fas fa-star"></i><i class="fas fa-star-half-alt"></i><i class="far fa-star"></i><i class="far fa-star"></i>
                                    <span class="product-m__review">(23)</span>
                                 </div>
                        ...
                        <div class="col-lg-4 col-md-6 col-sm-6">
                           <div class="product-m">
                              ...
                              <div class="product-m__content">
                                 ...
                                 <div class="product-m__name">
                                    <a href="product-detail.php">New Dress C Nice Elegant</a>
                                 </div>
                                 <div class="product-m__rating gl-rating-style"><i class="fas fa-star"></i><i class="fas fa-star"></i><i class="fas fa-star-half-alt"></i><i class="far fa-star"></i><i class="far fa-star"></i>
                                    <span class="product-m__review">(23)</span>
                                 </div>
                        ...
                        <div class="col-lg-4 col-md-6 col-sm-6">
                           <div class="product-m">
                              ...
                              <div class="product-m__content">
                                 ...
                                 <div class="product-m__name">
                                    <a href="product-detail.php">New Fashion E Nice Elegant</a>
                                 </div>
                                 <div class="product-m__rating gl-rating-style"><i class="fas fa-star"></i><i class="fas fa-star"></i><i class="fas fa-star-half-alt"></i><i class="far fa-star"></i><i class="far fa-star"></i>
                                    <span class="product-m__review">(23)</span>
                                 </div>
                        ...
                        <div class="col-lg-4 col-md-6 col-sm-6">
                           <div class="product-m">
                              ...
                              <div class="product-m__content">
                                 ...
                                 <div class="product-m__name">
                                    <a href="product-detail.php">New Fashion F Nice Elegant</a>
                                 </div>
                                 <div class="product-m__rating gl-rating-style"><i class="fas fa-star"></i><i class="fas fa-star"></i><i class="fas fa-star-half-alt"></i><i class="far fa-star"></i><i class="far fa-star"></i>
                                    <span class="product-m__review">(23)</span>
                                 </div>
                        ...
                        <div class="col-lg-4 col-md-6 col-sm-6">
                           <div class="product-m">
                              ...
                              <div class="product-m__content">
                                 ...
                                 <div class="product-m__name">
                                    <a href="product-detail.php">Red Wireless Headphone</a>
                                 </div>
                                 <div class="product-m__rating gl-rating-style"><i class="fas fa-star"></i><i class="fas fa-star"></i><i class="fas fa-star-half-alt"></i><i class="far fa-star"></i><i class="far fa-star"></i>
                                    <span class="product-m__review">(23)</span>
                                 </div>
                        ...
                        <div class="col-lg-4 col-md-6 col-sm-6">
                           <div class="product-m">
                              ...
                              <div class="product-m__content">
                                 ...
                                 <div class="product-m__name">
                                    <a href="product-detail.php">Yellow Wireless Headphone</a>
                                 </div>
                                 <div class="product-m__rating gl-rating-style"><i class="fas fa-star"></i><i class="fas fa-star"></i><i class="fas fa-star-half-alt"></i><i class="far fa-star"></i><i class="far fa-star"></i>
                                    <span class="product-m__review">(23)</span>
                                 </div>
                        ...
                        <div class="col-lg-4 col-md-6 col-sm-6">
                           <div class="product-m">
                              ...
                              <div class="product-m__content">
                                 ...
                                 <div class="product-m__name">
                                    <a href="product-detail.php">Hover Skateboard Scooter</a>
                                 </div>
                                 <div class="product-m__rating gl-rating-style"><i class="fas fa-star"></i><i class="fas fa-star"></i><i class="fas fa-star-half-alt"></i><i class="far fa-star"></i><i class="far fa-star"></i>
                                    <span class="product-m__review">(23)</span>
                                 </div>
                        ...
                        <div class="col-lg-4 col-md-6 col-sm-6">
                           <div class="product-m">
                              ...
                              <div class="product-m__content">
                                 ...
                                 <div class="product-m__name">
                                    <a href="product-detail.php">Hover Red Skateboard Scooter</a>
                                 </div>
                                 <div class="product-m__rating gl-rating-style"><i class="fas fa-star"></i><i class="fas fa-star"></i><i class="fas fa-star-half-alt"></i><i class="far fa-star"></i><i class="far fa-star"></i>
                                    <span class="product-m__review">(23)</span>
                                 </div>
                        ...
                        <div class="col-lg-4 col-md-6 col-sm-6">
                           <div class="product-m">
                              ...
                              <div class="product-m__content">
                                 ...
                                 <div class="product-m__name">
                                    <a href="product-detail.php">Canon DSLR Camera 4k</a>
                                 </div>
                                 <div class="product-m__rating gl-rating-style"><i class="fas fa-star"></i><i class="fas fa-star"></i><i class="fas fa-star-half-alt"></i><i class="far fa-star"></i><i class="far fa-star"></i>
                                    <span class="product-m__review">(23)</span>
                                 </div>
                        ...
                        <div class="col-lg-4 col-md-6 col-sm-6">
                           <div class="product-m">
                              ...
                              <div class="product-m__content">
                                 ...
                                 <div class="product-m__name">
                                    <a href="product-detail.php">Nikon DSLR Camera 4k</a>
                                 </div>
                                 <div class="product-m__rating gl-rating-style"><i class="fas fa-star"></i><i class="fas fa-star"></i><i class="fas fa-star-half-alt"></i><i class="far fa-star"></i><i class="far fa-star"></i>
                                    <span class="product-m__review">(23)</span>
                                 </div>
                  ...
                  <div class="u-s-p-y-60">
                     ...
                     <ul class="shop-p__pagination">
                        <li class="is-active">
                           <a href="shop-side-version-2.php">1</a>
                        </li>
                        <li>
                           <a href="shop-side-version-2.php">2</a>
                        </li>
                        <li>
                           <a href="shop-side-version-2.php">3</a>
                        </li>
                        <li>
                           <a href="shop-side-version-2.php">4</a>
                        </li>
                        <li>
                           <a class="fas fa-angle-right" href="shop-side-version-2.php"></a>
                        </li>
                     </ul>
                     <!--====== End - Pagination ======-->
                  </div>
