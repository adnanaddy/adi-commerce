                                ...
                                <div class="u-s-p-y-60">
                                    ...
                                    <ul class="shop-p__pagination">
                                        <li class="is-active">
                                            ...
                                            <a href="shop-list-full.php">1</a></li>
                                        <li>

                                            <a href="shop-list-full.php">2</a></li>
                                        <li>

                                            <a href="shop-list-full.php">3</a></li>
                                        <li>

                                            <a href="shop-list-full.php">4</a></li>
                                        <li>

                                            <a class="fas fa-angle-right" href="shop-list-full.php"></a></li>
                                    </ul>
                                    <!--====== End - Pagination ======-->
                                </div>
                            </div>
...
<?php require_once 'inc/sidebar-filters.php' ?>
