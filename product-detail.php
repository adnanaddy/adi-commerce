<?php require_once 'inc/header.php' ?>
        ...
        <div class="app-content">
            ...
            <div class="u-s-p-t-90">
                <div class="u-s-p-x-90 container-fluid border-bottom">
                    <div class="row">
                        ...
                        <div class="col-lg-5 col-md-6">
                            ...
                            <div class="pd-detail">
                                ...
                                <div class="u-s-m-b-15">
                                    ...
                                    <span class="pd-detail__preview-desc">Lorem Ipsum is simply dummy text of the printing and typesetting industry. when an unknown printer took a galley of type and scrambled it to make a type specimen book.</span></div>
                                <div class="u-s-m-b-15">
                                    <div class="pd-detail__inline">
                        ...
                        <div class="col-lg-3">
                            <div class="pd-options dash__box dash__box--bg-grey dash__box--radius dash__box--border u-s-m-b-30">
                                <p class="opt-heading u-s-m-b-1">Delivery Options</p>
                                <div class="br-bottom u-s-p-y-12">
                                    <div class="opt_icon">
                                        <i class="fas fa-map-marker-alt u-s-m-r-18"></i>
                                        <span class="opt_text">K.P.K - Swat Mingora, Makan Bagh, 1021</span>
                                        <span class="opt_link"><a href="#">CHANGE</a></span>
                                    </div>
                                </div>
                                <div class="u-s-p-y-12">
                                    <div class="opt_icon">
                                        <i class="fas fa-home u-s-m-r-18"></i>
                                        <p class="opt_text">Home Delivery
                                            <span>4-8 days</span></p>
                                        <span class="opt_link"><a>Rs: 100</a></span>
                                    </div>
                                </div>
                                <div class="br-bottom u-s-p-y-12">
                                    <div class="opt_icon">
                                        <i class="fas fa-dollar-sign u-s-m-r-18"></i>
                                        <p class="opt_text">Cash on Delivery Available</p>
                                    </div>
                                </div>

                                <p class="opt-heading u-s-m-t-10">Return & Warranty</p>
                                <div class="u-s-p-y-12">
                                    <div class="opt_icon">
                                        <i class="fas fa-history u-s-m-r-18"></i>
                                        <p class="opt_text">7 Days Warranty
                                            <span>Change of mind is not applicable</span>
                                        </p>
                                    </div>
                                    <div class="u-s-p-t-12">
                                        <div class="opt_icon">
                                            <i class="fas fa-eye-slash u-s-m-r-18"></i>
                                            <p class="opt_text">Warranty not available</p>
                                        </div>
                                    </div>
                                </div>
                            </div>

                            <div class="pd-options dash__box dash__box--bg-grey dash__box--radius dash__box--border">
                                <p class="opt-heading u-s-m-b-1">Sold by</p>
                                <div class="br-bottom u-s-p-b-12">
                                    <div class="opt_icon">
                                        <span class="opt_text fw-600">SV ECOMMERCE</span>
                                    </div>
                                </div>
                                <div class="u-s-p-y-12 br-bottom">
                                    <div class="row no-gutters">
                                        <div class="col-4 col-xl-md">
                                            <div class="info-title">Seller Rating</div>
                                            <div class="info-value ">92%</div>
                                        </div>
                                        <div class="col-4 col-xl-md">
                                            <div class="info-title">Ship on time</div>
                                            <div class="info-value ">95%</div>
                                        </div>
                                        <div class="col-4 col-xl-md">
                                            <div class="info-title">Chat Response</div>
                                            <div class="info-value ">98%</div>
                                        </div>
                                    </div>
                                </div>
                                <div class="u-s-p-t-12 text-center">
                                    <span class="opt_link"><a href="#">GO TO STORE</a></span>
                                </div>
                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="section__text-wrap">
                                    <div>
                                        <h1 class="section__heading u-c-secondary">CUSTOMER ALSO VIEWED</h1>
                                ...
                                <div class="u-s-m-b-30">
                                    <div class="product-o product-o--hover-on">
                                        ...
                                        <span class="product-o__name">
                                            ...
                                            <a href="product-detail.php">Beats Bomb Wireless Headphone</a></span>
                                ...
                                <div class="u-s-m-b-30">
                                    <div class="product-o product-o--hover-on">
                                        ...
                                        <span class="product-o__name">
                                            ...
                                            <a href="product-detail.php">Razor Gear Ultra Slim 8GB Ram</a></span>
                                        <div class="product-o__rating gl-rating-style"><i class="fas fa-star"></i><i class="fas fa-star"></i><i class="fas fa-star"></i><i class="fas fa-star"></i><i class="fas fa-star"></i>
                                ...
                                <div class="u-s-m-b-30">
                                    <div class="product-o product-o--hover-on">
                                        ...
                                        <span class="product-o__name">
                                            ...
                                            <a href="product-detail.php">Razor Gear Ultra Slim 12GB Ram</a></span>
                                        <div class="product-o__rating gl-rating-style"><i class="fas fa-star"></i><i class="fas fa-star"></i><i class="fas fa-star"></i><i class="fas fa-star"></i><i class="fas fa-star"></i>
                                ...
                                <div class="u-s-m-b-30">
                                    <div class="product-o product-o--hover-on">
                                        ...
                                        <span class="product-o__name">
                                            ...
                                            <a href="product-detail.php">Razor Gear Ultra Slim 16GB Ram</a></span>
                                        <div class="product-o__rating gl-rating-style"><i class="fas fa-star"></i><i class="fas fa-star"></i><i class="fas fa-star"></i><i class="fas fa-star"></i><i class="fas fa-star"></i>
