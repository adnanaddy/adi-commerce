               ...
               <div class="shop-p">
                  ...
                  <div class="u-s-p-y-60">
                     ...
                     <ul class="shop-p__pagination">
                        <li class="is-active">
                           <a href="shop-list-left.php">1</a>
                        </li>
                        <li>
                           <a href="shop-list-left.php">2</a>
                        </li>
                        <li>
                           <a href="shop-list-left.php">3</a>
                        </li>
                        <li>
                           <a href="shop-list-left.php">4</a>
                        </li>
                        <li>
                           <a class="fas fa-angle-right" href="shop-list-left.php"></a>
                        </li>
                     </ul>
                     <!--====== End - Pagination ======-->
                  </div>
